...
import genuinePartsData from "@/dictionary/genuine-parts.json";
...
async function fetchgenuinePartsData(
  ...
  try {
    ...
    try {
      ...
      return genuinePartsData as GenuinePartsItem;
    }
  }
}
...
export default async function GenuineParts({ params: { locale } }: Props) {
  if (!locales.includes(locale as any)) {
    locale = "en";
  }
