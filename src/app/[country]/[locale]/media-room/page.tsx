...
import mediaRoomData from "@/dictionary/mediaroom.json";
...
async function fetchmediaRoomData(locale: string): Promise<MediaRoomItem | null> {
  try {
    ...
    try {
      ...
      return mediaRoomData as unknown as MediaRoomItem;
    }
  }
}
...
export default async function MediaRooms({ params: { locale } }: Props) {
  if (!locales.includes(locale as any)) {
    locale = "en";
  }
