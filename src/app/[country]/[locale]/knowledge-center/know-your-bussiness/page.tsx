...
import knowYourBusinessData from "@/dictionary/know-your-business.json";
...
async function fetchknowYourBussinessData(
  ...
  try {
    ...
    try {
      ...
      return knowYourBusinessData as KnowYourBussinessItem;
    }
  }
}
...
export default async function KnowYourBusiness({ params: { locale } }: Props) {
  if (!locales.includes(locale as any)) {
    locale = "en";
  }
