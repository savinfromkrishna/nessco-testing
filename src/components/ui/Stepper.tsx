...
export default function Stepper({ onStepChange, categories }: StepperProps) {
  ...
  return (
    <div
      className={`lg:sticky z-30 lg:top-[5.8rem] max-w-screen-2xl left-0 w-full overflow-hidden ${
        activeStep > 0 ? "bg-[#f2f2f2]" : "bg-[#f2f2f2]"
      }`}
    >
      <div className="relative flex items-center justify-center w-full  h-24 mx-auto pb-2">
